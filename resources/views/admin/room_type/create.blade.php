...
@section('title',config('constant.company_name').' Create Room Type')
@section('extra_css')
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    <form id="submit_form" data-action="{{ route('room_type.store') }}" method="post">
                      @csrf
                              ...
                              if (response.responseJSON.errors.hasOwnProperty('name')) {
                               ...
                               if (response.responseJSON.errors.hasOwnProperty('price')) {
                                ...
                                if (response.responseJSON.errors.hasOwnProperty('description')) {
                                 ...
                                 if (response.responseJSON.errors.hasOwnProperty('amenities')) {
                                      $('.error_amenity').html(response.responseJSON.errors.amenities)      
                                  }else{
                                      $('.error_amenity').html('') 
                                  }
