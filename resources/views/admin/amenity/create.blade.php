...
@section('title',config('constant.company_name').' Create Amenity')
@section('main')
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    <form id="submit_form" data-action="{{ route('amenity.store') }}" method="post">
                      @csrf
                      
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Amenity Name <i class="icofont icofont-info-circle" title="Required"></i></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" placeholder="Amenity Name">
