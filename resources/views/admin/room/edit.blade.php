...
@section('title',config('constant.company_name').' Update Room')
@section('extra_css')
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    <form id="submit_form" data-action="{{ route('room.update') }}" method="post">
                      @csrf
                      <input type="hidden" name="id" value="{{$data->id}}">
                               ...
                               <select class="form-control" name="room_type_id">
                                <option value="">Select Room Type</option>
                                 @foreach ($room_types as $room_type)
                                     <option value="{{$room_type->id}}" {{$room_type->id==$data->room_type_id ? 'selected' : ''}}>{{$room_type->name}}</option>
                                 @endforeach
                               </select>
                               ...
                               <select class="form-control" name="floor_id">
                                <option value="">Select Floor</option>
                                 @foreach ($floors as $floor)
                                     <option value="{{$floor->id}}" {{$floor->id==$data->floor_id ? 'selected' : ''}}>{{$floor->floor_name}}</option>
                                 @endforeach
                               </select>
                               ...
                               <select class="form-control" name="room_keeper_id">
                                <option value="">Select Room Keeper</option>
                                 @foreach ($room_keepers as $room_keeper)
                                     <option value="{{$room_keeper->id}}" {{$room_keeper->id==$data->room_keeper_id ? 'selected' : ''}}>{{$room_keeper->name}}</option>
                                 @endforeach
                               </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-lg-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$data->room_number}}" name="room_number" id="room_number">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" value="{{$data->num_of_bed}}" name="num_of_bed">
