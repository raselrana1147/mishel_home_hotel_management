...
@section('title',config('constant.company_name').' Gallery List')
@section('main')
                ...
                <div class="card-block">
                    <form id="submit_form" data-action="{{ route('gallery.store') }}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Image <i class="icofont icofont-info-circle" title="Optional"></i></label>
                            <div class="col-sm-10">
