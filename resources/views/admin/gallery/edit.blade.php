...
@section('title',config('constant.company_name').' Update Gallery')
@section('main')
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    <form id="submit_form" data-action="{{ route('gallery.update') }}" method="post" enctype="multipart/form-data">
                      @csrf
                       ...
                       <div class="form-group row">
                           <label class="col-sm-2 col-form-label">Link <i class="icofont icofont-info-circle" title="Optional"></i></label>
                           <div class="col-sm-10">
                               <input type="text" class="form-control" name="link" placeholder="link" value="{{$data->link}}">
                               <span class="error_link" style="color: red;"></span>
                           </div>
                       </div>
                       <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                               <select class="form-control" name="type">
                                 ...
                                 <option value="picture" {{ $data->type=='picture' ? 'selected' : '' }}>Picture</option>
